...
export const LESSONS = [
  { id:1,  group:'home',      keys:['f','j'],         label:'F J' },
  { id:2,  group:'home',      keys:['d','k'],         label:'D K' },
  { id:3,  group:'home',      keys:['s','l'],         label:'S L' },
  { id:4,  group:'home',      keys:['a'],              label:'A' },
  { id:5,  group:'home',      keys:['a','s','d','f','g','h','j','k','l'],     label:'ASDFGHJKL' },
  { id:6,  group:'top',       keys:['r','u'],         label:'R U' },
  { id:7,  group:'top',       keys:['e','i'],         label:'E I' },
  { id:8,  group:'top',       keys:['w','o'],         label:'W O' },
  { id:9,  group:'top',       keys:['q','p'],         label:'Q P' },
  { id:10, group:'top',       keys:['q','w','e','r','t','y','u','i','o','p'], label:'QWERTYUIOP' },
  { id:11, group:'bottom',    keys:['b','n'],         label:'B N' },
  { id:12, group:'bottom',    keys:['v','m'],         label:'V M' },
  { id:13, group:'bottom',    keys:['z','x','c'],      label:'Z X C' },
  { id:14, group:'sentences', keys:['shift','.'],    label:'SHIFT .' },
  { id:15, group:'sentences', keys:[','],             label:',' },
  { id:16, group:'sentences', keys:['?','!'],         label:'? !' },
  { id:17, group:'sentences', keys:[':',';'],         label:': ;' },
  { id:18, group:'sentences', keys:['"',"'"],         label:'" \'' },
]
